...
class Autoencoder(nn.Module):
    """Defines an autoencoder NN that will compress and then decompress the observation grid data, attempting to
        recreate the original input data. This is intended to be used on either pavement or vehicles sensor data,
        and therefore expects input to be half of a full sensor data record (2 of the 4 layers).
    """
