...
class Constants:
    ...
    N_DISTRO_DIST_REAR      = 150.0     #distance to the rear of ego within which neighbors should be initially placed, m
    N_DISTRO_DIST_FRONT     = 250.0     #distance to the front of ego within which neighbors should be initially placed, m
